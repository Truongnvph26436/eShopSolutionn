...
namespace eShopsolution.Application.Catalog.Products
{
    public class ManageProductService : IManageProductService
    {
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            productTranslations.Name = request.Name;//Lỗi
        ...
        {
            ProductImageViewModel requestImage = new ProductImageViewModel();
            var Image = new ProductImage()
            {
                Id = requestImage.Id,
                ImagePath = requestImage.FilePath,
                FileSize = requestImage.FileSize
            };
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            var productTranslation = await _context.ProductTranslations.FirstOrDefaultAsync(c => c.ProductId == productId && c.LanguageId == languageId);
